...
show_help() {
    cat <<EOF
🐳 Optimizador y Configurador de Podman Rootless - Arch Linux (Niri + Dank Material Shell)
...
Características configuradas:
  • Base Arch Linux:        Verifica e instala complementos opcionales (podman-compose, podman-docker, cockpit-podman, passt).

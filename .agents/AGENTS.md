# Antigravity Environment: Arch Linux Expert Profile
...
- **Arch Linux** (Rolling Release, gestión de paquetes Pacman/AUR, kernel zen/oficial, systemd, hardening).
